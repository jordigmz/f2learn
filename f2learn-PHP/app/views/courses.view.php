						...
						<div class="widget-inner">
							<div class="card-courses-list admin-courses">
								<div class="card-courses-media">
									<img src="/assets/admin/images/courses/pic1.jpg" alt=""/>
								</div>
										...
										<ul class="card-courses-view">
											<li class="card-courses-user">
												<div class="card-courses-user-pic">
													<img src="/assets/admin/images/testimonials/pic3.jpg" alt=""/>
												</div>
							...
							<div class="card-courses-list admin-courses">
								<div class="card-courses-media">
									<img src="/assets/admin/images/courses/pic2.jpg" alt=""/>
								</div>
								<div class="card-courses-full-dec">
									<div class="card-courses-title">
										<h4>Become a PHP Master and Make Money</h4>
							...
							<div class="card-courses-list admin-courses">
								<div class="card-courses-media">
									<img src="/assets/admin/images/courses/pic3.jpg" alt=""/>
								</div>
								<div class="card-courses-full-dec">
									<div class="card-courses-title">
										<h4>Become a PHP Master and Make Money</h4>
							...
							<div class="card-courses-list admin-courses">
								<div class="card-courses-media">
									<img src="/assets/admin/images/courses/pic4.jpg" alt=""/>
								</div>
								<div class="card-courses-full-dec">
									<div class="card-courses-title">
										<h4>Become a PHP Master and Make Money</h4>
