        <div class="container">
            ...
            <form class="contact-bx" action="/gallery-images/new" method="post" enctype="multipart/form-data">
                <div class="heading-bx left">
                    <h2 class="title-head">Upload <span>images</span></h2>
                    <p>Form for adding images to the portfolio</p>
                </div>
                <div class="row placeani">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label style="color: #6C757D; font-weight: normal; user-select: none;">Category *</label>
                            <select name="category">
                                <?php foreach($categories ?? [] as $category) : ?>
                                    <option value="<?= $category->getId() ?>" <?= ($categorySelected == $category->getId()) ? 'selected' : '' ?> ><?= ucfirst($category->getName()) ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
            ...
            <!-- Content END-->
            <?php include __DIR__ . '/partials/gallery.part.php'; ?>
        </div>
    </div>
</main>
