                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-5">
                                    <ul class="course-features">
                                        ...
                                        <li><i class="ti-help-alt"></i> <span class="label">Host</span> <span class="value">F2Learn</span></li>
                    ...
                    <div class="col-lg-4 col-md-5 col-sm-12 m-b30">
                        <div class="bg-primary text-white contact-info-bx m-b30">
                            ...
                            <ul class="list-inline contact-social-bx">
                                <li><a href="https://twitter.com/" target="_blank" class="btn outline radius-xl"><i class="fa fa-twitter"></i></a></li>
                                <li><a href="https://es-es.facebook.com/" target="_blank" class="btn outline radius-xl"><i class="fa fa-facebook"></i></a></li>
                                <li><a href="https://www.instagram.com/" target="_blank" class="btn outline radius-xl"><i class="fa fa-instagram"></i></a></li>
                                <li><a href="https://es.linkedin.com/" target="_blank" class="btn outline radius-xl"><i class="fa fa-linkedin"></i></a></li>
                            </ul>
                        </div>
