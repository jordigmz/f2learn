 ...
 */
final class Version20220211112730 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX FK_A9A55A4CD4DB71B5 ON courses');
        $this->addSql('ALTER TABLE courses DROP level, DROP language, DROP assessments');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX FK_A9A55A4CD4DB71B5 ON courses (language)');
